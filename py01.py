...
def is_player_win():
    ...
    count = 1
    for x in range(1,10):
        if 0 <= player_row-1+x <= 8 and board[player_row-1+x][player_col-1] == 1:
            count += 1
    ...
    count = 1
    for x in range(1,10):
        if 0 <= player_col-1+x <= 8 and board[player_row-1][player_col-1+x] == 1:
            count += 1
        if count < 5 and board[player_row-1][player_col-1+x] != 1 or player_col-1+x > 8:
          break
            ...
            return True
    for x in range(1,10):
        if 0 <= player_row-1-x <= 8 and board[player_row-1][player_col-1-x] == 1:
            count += 1
    ...
    count = 1
    for x in range(1,10):
        if 0 <= player_row-1-x <= 8 and 0 <= player_col-1-x <= 8 and board[player_row-1-x][player_col-1-x] == 1:
            count += 1
    ...
    for x in range(1,9):
        ...
        if count < 5 and board[player_row-1+x][player_col-1-x] != 1:
            if board[player_row-1+x][player_col-1-x] == 0 and max_count < count:
                ...
                max_count = count
            break
        if player_row-1+x > 8 or player_col-1-x < 0:
            break
    for x in range(1,9):
        if board[player_row-1-x][player_col-1+x] == 1:
            count += 1
        if count < 5 and board[player_row-1-x][player_col-1+x] != 1:
            if board[player_row-1-x][player_col-1+x] == 0 and max_count < count:
                ...
                max_count = count
            break
        if player_row-1-x <0 or player_col-1+x > 8:
            break
    count = 1
    for x in range(1,9):
        if board[player_row-1-x][player_col-1-x] == 1:
        ...
        if count < 5 and board[player_row-1-x][player_col-1-x] != 1:
            if board[player_row-1-x][player_col-1-x] == 0 and max_count < count:
                ...
                max_count = count
            break
        if player_col-1-x < 0 or player_row-1-x < 0:
            break
    for x in range(1,9):
        if board[player_row-1+x][player_col-1+x] == 1:
            count += 1
        if count < 5 and board[player_row-1+x][player_col-1+x] != 1:
            if board[player_row-1+x][player_col-1+x] == 0 and max_count < count:
                ...
                max_count = count
            break
        if player_col-1+x > 8 or player_row-1+x > 8:
            break
